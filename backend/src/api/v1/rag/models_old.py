...
class QueryRequest(BaseModel):
    ...
    collection: str = Field(default="project_knowledge_base", description="Collection to query")
...
class IndexRequest(BaseModel):
    ...
    collection: str = Field(default="project_knowledge_base", description="Target collection")
